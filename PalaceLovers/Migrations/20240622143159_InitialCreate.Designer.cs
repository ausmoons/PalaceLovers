...
namespace PalaceLovers.Migrations
{
    ...
    [Migration("20240622143159_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PalaceLovers.Models.Gallery", b =>
                {
            ...
            modelBuilder.Entity("PalaceLovers.Models.VisitingHours", b =>
                {
                    b.Property<int>("VisitingHoursId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VisitingHoursId"));
                    ...
                    b.HasKey("VisitingHoursId");

                    b.HasIndex("PalaceId");

                    b.ToTable("VisitingHours");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PalaceLovers.Models.User", null)
                        .WithMany()
